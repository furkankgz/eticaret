          ...
          <div class="x_content">
            ...
            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                $say=0;
                // while sayesinde bir çok kez slider tasarımı yapmamıza gerek kalmayarak veritabanında ne kadar slider var ise
                // o kadar slider eklenmesini sağlıyor :)
                ...
                <tr>
                 ...
                 <td><?php if(isset($slidercek['slider_ad'])){
                  echo $slidercek['slider_ad'];
                 } ?></td>
                 <td><?php if (isset($slidercek['slider_url'])) {
                   echo $slidercek['slider_url'];
                 } ?></td>
                 <td><?php if(isset($slidercek['slider_sira'])){ echo $slidercek['slider_sira']; } ?></td>
