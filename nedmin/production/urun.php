                ...
                while($uruncek=$urunsor->fetch(PDO::FETCH_ASSOC)) { $say++?>
                  ...
                  <tr>
                   ...
                   if ($uruncek['urun_onecikar']==0) { ?>
                      <a href="../netting/islem.php?urun_id=<?php echo $uruncek['urun_id'] ?>&onecikar=1&urun_onecikar=ok"><button class="btn btn-success btn-xs">Öne Çıkar</button></a>
                   <?php } elseif($uruncek['urun_onecikar']==1) { ?>
                      <a href="../netting/islem.php?urun_id=<?php echo $uruncek['urun_id'] ?>&onecikar=0&urun_onecikar=ok"><button class="btn btn-warning btn-xs">Kaldır</button></a>
                     <?php } ?></center></td>
                     <td><center><?php 
