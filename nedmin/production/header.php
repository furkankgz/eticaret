...
<head>
  ...
  <title>FurkanExpress Admin Panel</title>
      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;">
            <a href="index.php" class="site_title"><i class="fa fa-paw"></i> <span>FurkanExpress</span></a>
          </div>
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
             ...
             <li><a href="yorum.php"><i class="fa fa-comments-o"></i> Yorumlar </a></li>

             <li><a href="banka.php"><i class="fa fa-bank"></i> Bankalar </a></li>

             <li><a href="siparis.php"><i class="fa fa-cart-plus"></i> Siparişler </a></li>
