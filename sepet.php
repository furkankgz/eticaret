		...
		<table class="table table-bordered chart">
			...
			<tbody>
				...
				while($sepetcek=$sepetsor->fetch(PDO::FETCH_ASSOC)) {
					...
					<tr>
						<!--<td><form action="" method="POST"><center><button type="submit" name="sepetkaldir" class="btn btn-warning btn-md">Kaldır<input type="hidden" value="<?php echo $sepetcek['sepet_id'] ?>"></button></center></form></td>-->
						<td><center><img height="100" class="urun" src=" <?php echo $urunfotocek['urunfoto_resimyol']; ?> " alt=""></center></td>
