<!-- Start of furkanexpress Zendesk Widget script -->
<script id="ze-snippet" src="<?php echo $ayarcek['ayar_zopim'] ?>"> </script>
<!-- End of furkanexpress Zendesk Widget script -->
<div class="f-widget"><!--footer Widget-->
	<div class="container">
		<div class="row">
			<div class="col-md-4">
				<div class="title-widget-bg">
					<div class="title-widget-cursive">Giriş Yapın</div>
				</div>
				<form action="nedmin/netting/islem.php" method="POST" role="form">
					<ul class="tweets">
						<li><input type="email" class="form-control newstler-input" name="kullanici_mail" placeholder="Email"></li>
						<li><input type="password" class="form-control newstler-input" name="kullanici_password" placeholder="Şifre"></li>
						<li class="title-widget"><center><button name="kullanicigiris" class="btn btn-default btn-red">Giriş Yap</button></center></li>
					</ul>
				</form>
			...
			<div class="col-md-4">
				<div class="title-widget-bg">
					<div class="title-widget-cursive">Bize Katılın</div>
				</div>
				<div class="newsletter">
					<p>
						<a href="register">Buraya</a> tıklayarak bize katılabilirsin.
					</p> <br><br>
		...
		<div class="row">
			<div class="col-md-9">
				<!--	<ul class="footermenu"> footer nav
					...
					<div class="f-credit">&copy;<?php echo $ayarcek['ayar_author'] ?> <a href="index.php">FurkanExpress</a></div>
