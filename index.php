...
include 'header.php'; 
?>
<head><title><?php echo $ayarcek['ayar_title'] ?></title></head>
<div class="container">
			...
			while ($uruncek=$urunsor->fetch(PDO::FETCH_ASSOC)) {
				...
				<div class="item">
					<div class="productwrap">
						<div class="pr-img">
							<div class="hot"></div>
							<center><a href="urun-<?=seo($uruncek["urun_ad"]).'-'.$uruncek["urun_id"]?>"><img height="200" src="<?php echo $urunfotocek['urunfoto_resimyol'] ?>" alt="" class="urun"></a></center>
