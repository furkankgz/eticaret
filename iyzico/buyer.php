...
$adsoyad=explode(" ", $kullanici_adsoyad);

$kullanici_ad=$adsoyad[0];
$kullanici_soyad=$adsoyad[1];
$kullanici_gsm=$kullanicicek['kullanici_gsm'];
$kullanici_mail="mail@mail.com";
$kullanici_zaman="2020-04-29 15:12:34"; 
$kullanici_adresiyaz="Hadımköy / Arnavutköy";
...
$request->setCallbackUrl("http://furkanexpress.com/iyzico/sonuc.php?siparis_no=$siparis_no");
