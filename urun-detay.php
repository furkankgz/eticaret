...
<head>
	<title><?php echo $uruncek['urun_ad'] ?>-Furkanexpress</title>
			...
			<div class="row">
				<div class="col-md-6">
					...
					<div class="dt-img">
						...
						<center><a class="fancybox" href="<?php echo $urunfotocek['urunfoto_resimyol'] ?>" data-fancybox-group="gallery" title="<?php echo $uruncek['urun_ad'] ?>"><img height="250" src="<?php echo $urunfotocek['urunfoto_resimyol'] ?>" alt="" class="urun"></a></center>
					</div>
					...
					<div class="thumb-img">
						<a class="fancybox" href="<?php echo $urunfotocek['urunfoto_resimyol'] ?>" data-fancybox-group="gallery" title="<?php echo $uruncek['urun_ad'] ?>"><img  height="50" src="<?php echo $urunfotocek['urunfoto_resimyol'] ?>" alt="" class="urun"></a>
					</div>
							...
							while($urunaltcek=$urunaltsor->fetch(PDO::FETCH_ASSOC)) {
								...
								<div class="col-md-5">
									<div class="productwrap">
										<div class="pr-img">
											<div class="hot"></div>
											<center><a href="urun-<?=seo($urunaltcek["urun_ad"]).'-'.$urunaltcek["urun_id"]?>"><img height="200" src="<?php echo $urunfotocek['urunfoto_resimyol'] ?>" alt="" class="urun"></a></center>
